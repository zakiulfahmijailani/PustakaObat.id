...
const migrationPath = resolve('database/migrations/006_monograph_staging_v2_2.sql')
...
try {
  ...
  console.log(`Applied ${migrationPath}. Monograph staging tables present: ${tables.rows[0].count}`)
} finally {
  await client.end()
}
