  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        ...
        <Button asChild><Link href="/dashboard/obat/new"><Plus size={17} /> Tambah monografi lokal</Link></Button>
      </div>
