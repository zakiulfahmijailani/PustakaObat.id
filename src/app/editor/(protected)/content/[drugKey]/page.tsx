...
export default async function EditorContentDetailPage({ params }: { params: Promise<{ drugKey: string }> }) {
  ...
  const { concept, drafts, candidates, fullLabelCandidates, error } = await getStagedDrugForEditor(drugKey)
