...
import type { FullLabelCandidate } from '@/lib/staging/queries'
...
export function EditorialDraftForm({ drugKey, availableSections, drafts, aiCandidates, fullLabelCandidates }: { drugKey: string; availableSections: string[]; drafts: EditorialDraft[]; aiCandidates: IndonesianCandidateDraft[]; fullLabelCandidates: FullLabelCandidate[] }) {
